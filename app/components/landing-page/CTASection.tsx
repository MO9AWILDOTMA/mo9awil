...
export function CTASection({ isQuoteModalOpen, setIsQuoteModalOpen }: CTASectionProps) {
  return (
    <section
      id="contact"
        ...
        >
          ...
          <Dialog open={isQuoteModalOpen} onOpenChange={setIsQuoteModalOpen}>
            <DialogTrigger asChild>
              <Button
                size="lg"
                className="bg-white cursor-pointer text-blue-600 hover:bg-gray-300 px-8 py-4 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
