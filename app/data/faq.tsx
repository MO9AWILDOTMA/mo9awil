  ...
  items: [
    {
      ...
      a: (
        <>
          ...
          professionnelle enregistrée au Maroc. Ce service inclut la gestion du
          courrier, le transfert postal et l’utilisation de notre adresse pour
    ...
    {
      q: 'Quels services comptables sont inclus dans le forfait semestrielle ?',
      a: 'Notre forfait comptable semestrielle comprend la tenue de livres, la préparation des déclarations fiscales, les états financiers, la gestion de la paie, les bilans et la consultation pour l’optimisation fiscale.',
    },
    {
